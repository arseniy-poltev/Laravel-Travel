<section id="register-form" class="section gray-bg section-padded">
    <div class="container">
        <div class="row text-left title register-form-box">
            <form class="form-horizontal popup-form register_form" role="form" method="get"
                action="{{ url('holidays/search') }}">
                {{--{{ csrf_field() }}--}}
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="search_location">
                                <select class="form-control" id="select_location" name="location">
                                    ...
                                    <option value="{{ $location->id }}" @if(isset($search_param) &&
                                        $search_param['location'] && $search_param['location']==$location->id) selected
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="search_location">
                                <input class="form-control form-white" name="name" id="holiday_name" placeholder=""
                                    value=" @if(isset($search_param) && $search_param['name']){{ $search_param['name'] }}@endif">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-1 col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="checkbox checkbox-success">
                                <input type="checkbox" id="hotel" name="hotel" @if(isset($search_param) &&
                                    $search_param['hotel'] && $search_param['hotel']==1) checked @endif>
                    ...
                    <div class="col-md-1 col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="checkbox checkbox-success">
                                <input type="checkbox" name="wifi" id="wifi" @if(isset($search_param) &&
                                    $search_param['wifi'] && $search_param['wifi']==1) checked @endif>
                    ...
                    <div class="col-md-1 col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="checkbox checkbox-success">
                                <input type="checkbox" id="car_rental" name="car_rental" @if(isset($search_param) &&
                                    $search_param['car_rental'] && $search_param['car_rental']==1) checked @endif>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group search_btn_group">
                            ...
                            <div>
                                <button type="submit" id="btn_search_holiday"
                                    class="btn_search_holiday form-control btn btn-block btn-form btn-primary"
                                    value="Search" style="color: white ">Search</button>
                            </div>
                        </div>
                    </div>
                </div>
